              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {category.skills.map((skill, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 hover:border-indigo-500/40 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-indigo-950/20 group flex items-center justify-between"
                    >
                      <div className="flex items-center gap-3.5">
                        <div className="p-3 rounded-xl bg-slate-800/80 text-cyan-400 group-hover:bg-indigo-600/20 group-hover:text-indigo-300 transition-colors shrink-0">
